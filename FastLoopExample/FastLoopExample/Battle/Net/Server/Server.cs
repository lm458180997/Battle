...
namespace FastLoopExample.Battle.Net
{
    public class ServerTool
    {
        ...
        public static PlayerData data = new PlayerData();      //获取的人物数据

        public static PlayerData datasend = new PlayerData();  //发送的人物数据
        ...
        public void SetPlayerData(Players.BattlePlayer player)
        {
            player.ClonePeopleData(datasend);
        }
    ...
    public class ServerManager : NetworkManager
    {
        ...
        public void DataRecive(NetPacket packet)
        {
            ...
            PlayerData dt = ServerTool.datasend;
            rs.player_x1 = dt.player_x;
            rs.player_x2 = dt.player_y;
            rs.player_state = dt.playerstate;
            rs.adaptor_state = dt.adaptorstate;
            rs.currentindex = dt.currentindex;
            rs.totoleindex = dt.totleindex;
            rs.speed = dt.speed;
            rs.caculatetime = dt.caculatetime;
