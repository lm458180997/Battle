...
namespace FastLoopExample
{
    ...
    {
        public static float _OffsetY_ = 100;         //绘画中心向下偏移的距离单位
        ...
        public Form1()
        {
            ...
            _openGLControl.MouseDown += (s, e) =>
                {
                    MouseEventArgs ags = e as MouseEventArgs;
                    int X = e.X - 320;
                    int Y = 340 - e.Y;
                    DebugResult = "X:" + X.ToString() + " Y:" + Y.ToString();
                    Datas.TestX = X;
                    Datas.TestY = Y;
                };
            ...
            Gl.glTexParameteri(Gl.GL_TEXTURE_2D,
                ...
                Gl.GL_LINEAR);
            _system.ChangeState("MenuStage");    //切换进游戏场景
            //BattleStage1
            //MenuStage
            ...
            timer.Tick += (s, e) =>
                {
                    DebugResult = ("Kind: "+Datas.SelectGear + 
                        " X:"+Datas.TestX.ToString()+" Y:"+Datas.TestY.ToString());
                    this.Text = DebugResult;
                };
            timer.Start();
        ...
        void InitializeTextures()
        {
            ...
            ReadTextureFile("res\\menu\\gear\\menu_gear.tg");
            ReadTextureFile("res\\menu\\Logos\\MenuLogs.tg");
            ReadTextureFile("res\\menu\\connect\\connect.tg");
            ReadTextureFile("res\\menu\\components\\components.tg");
            ReadTextureFile("res\\battle\\battle.tg");
            _textureManager.LoadTexture("back", "back.png");
            _textureManager.LoadTexture("rect", "rect.png");
            _textureManager.LoadTexture("11_back", "res\\scene\\11_back.png");
            _textureManager.LoadTexture("12_back", "res\\scene\\12_back.png");
            _textureManager.LoadTexture("13_back", "res\\scene\\13_back.png");
            _textureManager.LoadTexture("14_back", "res\\scene\\14_back.png");
            _textureManager.LoadTexture("15_back", "res\\scene\\15_back.png");
            _textureManager.LoadTexture("bg_cursor0", "res\\scene\\bg_cursor0.png");
            _textureManager.LoadTexture("2_menu_black", "res\\scene\\2_menu_black.png");
            _textureManager.LoadTexture("2_menu_moji1", "res\\scene\\2_menu_moji1.png");
            _textureManager.LoadTexture("2_menu_moji2", "res\\scene\\2_menu_moji2.png");
            _textureManager.LoadTexture("weather06", "res\\menu\\weather\\06.png");
            _textureManager.LoadTexture("2_title", "res\\scene\\2_title.png");
            _textureManager.LoadTexture("2_menu_gear", "res\\scene\\2_menu_gear.png");
            _textureManager.LoadTexture("gearback", "res\\scene\\gearback.png");
            _textureManager.LoadTexture("2_menu_hari", "res\\scene\\2_menu_hari.png");
            _textureManager.LoadTexture("0000", "res\\0000.png");
            _textureManager.LoadTexture("door_l", "res\\menu\\door_l.png");
            _textureManager.LoadTexture("door_r", "res\\menu\\door_r.png");
        ...
        {
            _system.AddState("MenuStage", new Battle.Stages.Menu.MenuStage(this,_system, _textureManager, _soundManagerEx));//BattleStage1注册
        ...
        public void GameLoop(double elapsedTime)
        {
            ...
            {
                _system.Render();
                //渲染完以后重置矩阵（否则可能会出现矩阵中心偏移的情况，也就是画面移出屏幕外的bug）
                //Gl.glLoadIdentity();      
        ...
        private void Setup2DGraphics(double width, double height, bool iscenter = true)   //
        {
            ...
            {
                //这里使图片进行了y轴上的_OffsetY_向下偏移
                Gl.glOrtho(-halfWidth, halfWidth, -halfHeight + _OffsetY_, halfHeight + _OffsetY_, -100, 100);
            }
